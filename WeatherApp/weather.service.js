...
const API_KEY = '055eb145f131a4f47dfb6575bc769661'
const DEFAULT_OPTIONS = {
    coord: { lon: -75.76, lat: 56 }, // Algonquin College
    units: 'metric'
}
const cache = new Map()
...
export function createWeatherIcon(iconCode) {
    let img = `<img src="https://openweathermap.org/img/w/` + iconCode + `.png" alt="" class="card-img-top"/>`
    return img
}